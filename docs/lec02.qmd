...
3. **Model fit**: R² ≈ 0.67 means we explain 67% of price variation
...
1. **Customer segments** → Targeted marketing
2. **Fraud patterns** → Risk management  
3. **Market structure** → Competitive strategy
